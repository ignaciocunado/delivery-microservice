...
class DeliveryControllerTest {
    ...
    @Test
    void acceptDelivery() {
        Mockito.when(vendorController.checkAndHandle(Mockito.any(), Mockito.any())).thenReturn(new ResponseEntity<>(HttpStatus.OK));
    ...
    @Test
    void deliveryIdDone() {
        Mockito.when(courierController.checkAndHandle(Mockito.any(), Mockito.any())).thenReturn(new ResponseEntity<>(HttpStatus.OK));
    ...
    void testSetPickUpTime() {
        Mockito.when(vendorOrCourierController.checkAndHandle(Mockito.any(), Mockito.any())).thenReturn(new ResponseEntity<>(HttpStatus.OK));
    ...
    void testGetDeliveryException() {
        Mockito.when(globalController.getDeliveryException(deliveryId)).thenReturn(new ResponseEntity<>(HttpStatus.OK));
    ...
    void testGetDeliveryById() {
        Mockito.when(globalController.getDeliveryById(deliveryId)).thenReturn(new ResponseEntity<>(HttpStatus.OK));
    ...
    void testGetOrderByDeliveryId() {
        Mockito.when(globalController.getOrderByDeliveryId(deliveryId)).thenReturn(new ResponseEntity<>(HttpStatus.OK));
    ...
    void testGetRatingByDeliveryId() {
        Mockito.when(globalController.getRatingByDeliveryId(deliveryId)).thenReturn(new ResponseEntity<>(HttpStatus.OK));
    ...
    void testGetPickUpTime() {
        Mockito.when(globalController.getPickUpTime(deliveryId)).thenReturn(new ResponseEntity<>(HttpStatus.OK));
    ...
    void testGetAllDeliveriesCustomer() {
        ...
        Mockito.when(customerController.checkAndHandle(Mockito.any(), Mockito.any())).thenReturn(new ResponseEntity<>(HttpStatus.OK));
    ...
    void testSetRateOfDelivery() {
        Mockito.when(customerController.checkAndHandle(Mockito.any(), Mockito.any())).thenReturn(new ResponseEntity<>("", null, HttpStatus.OK));
